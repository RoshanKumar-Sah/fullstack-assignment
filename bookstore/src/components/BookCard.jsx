        ...
        <div className="w-full h-full pb-2  border-2 border-gray-400 shadow rounded-xl  hover:border-tertiary" key={book.id}>
            ...
            <div className="px-2 flex flex-col justify-around  h-2/5 ">
                ...
                <div className="flex justify-between">
                    ...
                    {
                        book.status[0] == "available" ? <div className={`py-1 px-2 h-fit font-medium rounded-md bg-primary text-white border hover:border-primary   hover:bg-white hover:text-primary ${open_sans.className} cursor-pointer`} onClick={() => {
                            if (localStorage.getItem("access_token")) {
                                let id = book._id
                                axios.post(`${URL_Domain}/cart/${id}`, {}, {
                                    headers: {
